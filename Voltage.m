...
C = 33*1e-6;     % Pojemność (farad)

% Częstotliwość sygnału AC
f = 100;        % Częstotliwość (Hz)
...
xlabel('Czas (s)');
ylabel('[mV]')
title('Napięcie na rezystorze i kondensatorze');
...
xlabel('Czas (s)');
ylabel('[V]')
title('Napięcie na rezystorze i cewce');
...
% w równoległym RLC będzie to samo napięcie na elementach równoległych